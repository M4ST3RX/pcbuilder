...
Route::get('/company/ranks/up', 'CompanyController@ranksMoveUp')->name('company.ranks.up');
Route::get('/company/ranks/down', 'CompanyController@ranksMoveDown')->name('company.ranks.down');
